...
- Freeform windowing with auto-positioning (portrait, 360x640 per instance)
...
| Mode | Freeform windowing, portrait, 360x640 per instance |
...
| 12 | Configure freeform display (360x640 per instance, dynamic total, portrait) |
